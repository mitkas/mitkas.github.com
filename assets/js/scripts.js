var phrases = [
  'My portfolio<br/> on <strong><a target="_blank" href="http://behance.net/mitka">Behance</a>.</strong>',
  'Some of my work<br/> on <strong><a target="_blank" href="http://dribbble.com/mitkazavr">Dribbble</a>.</strong>',
  'My account <br/> on <strong><a target="_blank" href="https://www.facebook.com/mitkazavr">Facebook</a>.</strong>',
  'My account <br/> on <strong><a target="_blank" href="https://plus.google.com/u/0/118216164257316781264">Google+</a>.</strong>'
];
...
$(document).ready(function(){
    ...
    $('a#copy-permalink').zclip({
        ...
        afterCopy:function(){
            $('.copied').fadeIn(500).delay(2000).fadeOut(500);
        }
    });
